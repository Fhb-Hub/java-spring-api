...
public interface BookSwagger {
    ...
    ResponseEntity<BookDTO> create(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Book data in JSON format")
    ...
    @GetMapping("/{id}")
    ResponseEntity<BookDTO> findById(@Parameter(description = "Unique ID of the book", example = "1") @PathVariable("id") Long id);
    ...
    ResponseEntity<BookDTO> update(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Updated book data in JSON format")
    @RequestBody BookDTO book);
